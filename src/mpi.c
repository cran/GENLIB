/*
    ...
    $Id: mpi.c,v 2.0 2003/09/23 20:58:20 sebasLec Exp $
 */
...
{  
  ...
  //positionne chaque variable mp_int
  for(pos = 0; pos < count; ++pos) 
  {
	SIGN(&mp[pos]) = MP_ZPOS;
	USED(&mp[pos]) = 1;
	ALLOC(&mp[pos]) = s_mp_defprec;
	DIGITS(&mp[pos])= &tableau[pos*s_mp_defprec];
  }
